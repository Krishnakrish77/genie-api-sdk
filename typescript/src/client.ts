...
export class GenieClient {
  ...
  /**
   * Reattach to a persisted Genie run, for example after an application restart
   * or after resolving a paused approval. `lastEventId` resumes from the next event.
   */
